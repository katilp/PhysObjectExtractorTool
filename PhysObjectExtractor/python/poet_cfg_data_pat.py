...
isData = True # force to data for condition data test
...
#if isData: process.GlobalTag.connect = cms.string('sqlite_file:/opt/cms-opendata-conddb/FT_53_LV5_AN1_data_stripped.db')
#else:  process.GlobalTag.connect = cms.string('sqlite_file:/opt/cms-opendata-conddb/START53_LV6A1_MC_stripped.db')
#if isData: process.GlobalTag.globaltag = 'FT_53_LV5_AN1::All'
#else: process.GlobalTag.globaltag = "START53_LV6A1::All"
...
if isData:
	goodJSON = "PhysObjectExtractor/data/Cert_160404-180252_7TeV_ReRecoNov08_Collisions11_JSON.txt"
